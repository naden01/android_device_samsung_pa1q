...
#   bash device/samsung/pa3q/patches/revert-patches.sh
#
...
#   0019-internal-storage-mountpoint.patch -> gui/theme/common/portrait.xml
#   0020-fix-data-storage-path.patch      -> partitions.hpp, partitionmanager.cpp, gui/gui.cpp
